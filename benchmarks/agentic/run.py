...
ARMS = {
    ...
    "ponytail":       lambda: _skill("benchmarks/vendor/ponytail/SKILL.md"),
    "caveman":        lambda: _skill("benchmarks/arms/caveman-SKILL.md"),
    "scalpel":        lambda: _skill("skills/scalpel/SKILL.md"),
...
# Symmetric activation: every skill arm is injected as its full SKILL.md text via
# --append-system-prompt — the same channel for ponytail, caveman, and scalpel — so no
# arm gets plugin machinery another lacks. (Upstream used --plugin-dir for its own arms.)
PLUGIN_ARMS = ()
